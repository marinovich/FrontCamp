...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "96e82cd97eb6ac0d6d11";
...
var NewsData = /** @class */ (function () {
    function NewsData(toggleElement, getItemElement, getTopRatedNewsListAsync) {
        var _this = this;
        this.setSources = function (sources) { return sources.forEach(function (sourceItem) { return _this.sourcesMap.set(sourceItem.id, sourceItem); }); };
        this.getSources = function () { return _this.sourcesMap; };
        // tslint:disable-next-line:no-any
        this.setTopRatedNews = function (news) { return _this.topRatedNews.set(news[0].source.id, news); };
        this.getTopRatedNewsById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var topRatedNews;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.topRatedNews.has(id)) {
                            return [2 /*return*/, this.topRatedNews.get(id)];
                        }
                        return [4 /*yield*/, this.getTopRatedNewsListAsync(id)];
                    case 1:
                        topRatedNews = _a.sent();
                        return [2 /*return*/, this.setTopRatedNews(topRatedNews).get(id)];
                }
            });
        }); };
    ...
    NewsData.prototype.toggleHeadlinesItem = function (eventTarget) {
        var targetElement = this.getItemElement(eventTarget);
        targetElement && this.toggleItemSelection(targetElement);
...
exports.__esModule = true;
exports.API_KEY = '7719cc235c3c4a4381f84089ece47f5f';
exports.API_VERSION = 'v2';
exports.BASE_URL = 'https://newsapi.org';
...
__webpack_require__(/*! images/default-news.png */ "./src/images/default-news.png");
// to support promises in ie11
...
var _this = this;
exports.__esModule = true;
var NewsData_1 = __webpack_require__(/*! NewsData */ "./src/NewsData.ts");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                newsData = new NewsData_1.NewsData(toggleItem, utils_1.getItemElement, services_1.getTopHeadlinesAsync);
                return [4 /*yield*/, services_1.getSourcesAsync()];
            case 1:
                sources = _a.sent();
                newsData.setSources(sources);
                services_1.renderList(sourceList, sourceItem, newsData.getSources());
                sourceList.addEventListener('click', showTopRatedArticlesBlock, { once: true });
                sourceList.addEventListener('click', function (_a) {
                    var item = _a.target;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, newsData.getTopRatedNewsById(utils_1.getElementId(item.id))];
                                case 1:
                                    articles = _b.sent();
                                    services_1.renderList(topRatedList, topRatedItem, articles);
                                    return [2 /*return*/];
                            }
                        });
                    });
 ...
 * @param parameters -
 */
exports.request = function (endpoint, parameters) {
    if (parameters === void 0) { parameters = ''; }
    return __awaiter(_this, void 0, void 0, function () {
        var response, _a, status, message, result;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, fetch(constants_1.BASE_URL + "/" + constants_1.API_VERSION + "/" + endpoint + "?" + (parameters && parameters + "&") + "apiKey=" + constants_1.API_KEY)];
                case 1:
                    response = _b.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    _a = _b.sent(), status = _a.status, message = _a.message, result = __rest(_a, ["status", "message"]);
...
exports.__esModule = true;
__export(__webpack_require__(/*! ./newsApi */ "./src/services/newsApi.ts"));
__export(__webpack_require__(/*! ./renderList */ "./src/services/renderList.ts"));
...
exports.getSourcesAsync = function () { return __awaiter(_this, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, request_1.request('sources')];
            case 1:
 ...
 */
exports.getTopHeadlinesAsync = function (sourceId) { return __awaiter(_this, void 0, Promise, function () {
    var articles;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, request_1.request('top-headlines', "sources=" + sourceId)];
            case 1:
 ...
 */
exports.renderList = function (list, item, data) {
    var documentFragmentList = document.createDocumentFragment();
    data.forEach(function (element) {
        var newItem = item.cloneNode(true);
        var children = utils_1.flattenChildNodes(newItem);
        // TODO: need to create a separate service(s)
        children.forEach(function (item) {
            switch (item.id) {
                // for source items
                case 'source-image':
                    item.src = utils_1.generateLogoUrl(element.url);
                    break;
                case 'source-caption':
            ...
            item.id = item.id && item.id + "_" + (element.id || utils_1.generateUniqueId());
        });
        newItem.id = item.id + "_" + (element.id || utils_1.generateUniqueId());
 ...
 */
function flattenChildNodes(element) {
...
exports.flattenChildNodes = flattenChildNodes;
 ...
 * @param {number} size
 */
exports.generateLogoUrl = function (url, size) {
...
exports.__esModule = true;
exports.generateUniqueId = function () { return Math.random().toString(36).substr(2, 16); };
...
exports.__esModule = true;
exports.getItemElement = function (element) {
    ...
    return exports.getItemElement(element.parentElement);
};
...
exports.__esModule = true;
__export(__webpack_require__(/*! ./flattenChildNodes */ "./src/utils/flattenChildNodes.ts"));
__export(__webpack_require__(/*! ./generateLogoUrl */ "./src/utils/generateLogoUrl.ts"));
__export(__webpack_require__(/*! ./generateUniqueId */ "./src/utils/generateUniqueId.ts"));
__export(__webpack_require__(/*! ./getElementId */ "./src/utils/getElementId.ts"));
__export(__webpack_require__(/*! ./getSourceItemElement */ "./src/utils/getSourceItemElement.ts"));
